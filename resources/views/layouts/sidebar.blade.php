<div class="col-12 col-lg-3 col-navbar d-none d-xl-block">
    <aside class="sidebar">
        ...
        <a href="/" class="sidebar-item {{ Request::is('dashboard', '/') ? 'active' : '' }}"
            onclick="toggleActive(this)">
            {{-- <img src="{{ asset('template/assets/img/global/grid.svg') }}" alt=""> --}}
        ...
        {{-- <a href="/karyawan" class="sidebar-item"> --}}
        {{-- <img src="{{ asset('template/assets/img/global/users.svg') }}" alt=""> --}}
        <a href="/karyawan" class="sidebar-item {{ Request::is('karyawan', 'karyawan/*') ? 'active' : '' }}"
            onclick="toggleActive(this)">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <h5 class="sidebar-title">Monitoring</h5>

        <a href="/samplemasuk" class="sidebar-item {{ Request::is('samplemasuk', 'samplemasuk/*') ? 'active' : '' }}"
            onclick="toggleActive(this)">
            {{-- <img src="{{ asset('template/assets/img/global/box.svg') }}" alt=""> --}}
            {{-- <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="/samplekeluar" class="sidebar-item {{ Request::is('samplekeluar', 'samplekeluar/*') ? 'active' : '' }}"
            onclick="toggleActive(this)">
            {{-- <img src="{{ asset('template/assets/img/global/home.svg') }}" alt=""> --}}
            {{-- <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span>Sample Keluar</span>
        </a>

        <a href="/laborat" class="sidebar-item {{ Request::is('laborat', 'laborat/*') ? 'active' : '' }}"
            onclick="toggleActive(this)">
            {{-- <img src="{{ asset('template/assets/img/global/gift.svg') }}" alt=""> --}}
            {{-- <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        @can('gate_admin')
            ...
            {{-- <a href="/claim" class="sidebar-item {{ Request::is('claim') ? 'active' : '' }}"
                onclick="toggleActive(this)">
            ...
            <a href="/pengguna" class="sidebar-item {{ Request::is('pengguna', 'pengguna/*') ? 'active' : '' }}"
                onclick="toggleActive(this)">
                {{-- <img src="{{ asset('template/assets/img/global/settings.svg') }}" alt=""> --}}
        ...
        <form action="/logout" method="get" class="d-inline">
            <span onclick="toggleActive(this)" class="sidebar-item">
                @csrf
                <button type="submit" style="border: none; background: 0%;">

                    {{-- <img src="{{ asset('template/assets/img/global/log-out.svg') }}" alt=""> --}}
